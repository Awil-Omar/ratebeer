...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference("Membership.count") do
      post memberships_url, params: { membership: { beer_club_id: @membership.beer_club_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { beer_club_id: @membership.beer_club_id } }
